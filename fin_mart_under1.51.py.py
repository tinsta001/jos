...
while True:
    try:
        timer1=WebDriverWait(driver, 800).until(EC.text_to_be_present_in_element((By.XPATH,"/html/body/app-root/div[1]/app-scheduled/div/main/app-event-list/div/div/div[2]/app-market-panel[1]/div/app-market-header/div/div[1]/app-countdown/span"),"00:36"))
        print(timer1)
        cow()
        if cow.li!=[]:
            for row in cow.li:
            ...
            for p in itertools.islice(result,0,2):
                ...
                time.sleep(1)
                #OVER2.5
                                                                            # /html/body/app-root/div[1]/app-scheduled/div/main/app-event-detail/div/div/div[2]/app-event-detail-content/div[3]/app-market/div/app-over-under-football/div/div[1]/div/app-odd[2]/div/div/div[2]
                matchunder1=wait.until(EC.element_to_be_clickable((By.XPATH,"/html/body/app-root/div[1]/app-scheduled/div/main/app-event-detail/div/div/div[2]/app-event-detail-content/div[3]/app-market/div/app-over-under-football/div/div[1]/div/app-odd[2]/div/div/div[2]")))
            ...
            print("Done")
            stake_amount1=wait.until(EC.element_to_be_clickable((By.XPATH, "//*[@id='bets-stake-amount-1']")))#//*[@id="bets-stake-amount-1"]
            driver.execute_script("arguments[0].click();", stake_amount1)
            stake_amount1.send_keys("11")
            time.sleep(1)
        ...
        if win==0:
            l=0
            timer1=WebDriverWait(driver, 800).until(EC.text_to_be_present_in_element((By.XPATH,"/html/body/app-root/div[1]/app-scheduled/div/main/app-event-list/div/div/div[2]/app-market-panel[1]/div/app-market-header/div/div[1]/app-countdown/span"),"01:05"))
            print(timer1)
            coun()
            print(coun.ti)
            if com(coun.ti,c) == 0:
                ...
                if cow.li!=[]:
                    ...
                    for p in itertools.islice(result,0,2):
                        ...
                        driver.execute_script("arguments[0].click();", sub)
                    if l==0  :  
                        stake_amount1=wait.until(EC.element_to_be_clickable((By.XPATH, "//*[@id='bets-stake-amount-1']")))
                        driver.execute_script("arguments[0].click();", stake_amount1)
                        stake_amount1.send_keys("33")
                        time.sleep(1)
                        submit=wait.until(EC.element_to_be_clickable((By.XPATH,"//*[@id='main-right']/app-bet-sidebar/div[1]/div[1]/app-betslip/div/div/button")))
                        driver.execute_script("arguments[0].click();", submit)
                        time.sleep(3)
